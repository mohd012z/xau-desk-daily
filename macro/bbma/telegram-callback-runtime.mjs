...
export async function handleTelegramCallback({update,getObservation,getCurrentStatus,answerCallback,respond}={}){
  ...
  const routed=routeBbmaTelegramCallback({data:q.data,getObservation,getCurrentStatus});
